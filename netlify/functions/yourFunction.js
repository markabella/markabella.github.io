...
exports.handler = async (event) => {
  ...
  const prompt = `As Saint John Climacus, author of "The Ladder of Divine Ascent," answer the following question in a manner consistent with the teachings found in the book: ${question}`;
